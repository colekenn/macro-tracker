  ...
  async function fetchSuggestions(query) {
    ...
    try {
      const response = await fetch(`https://trackapi.nutritionix.com/v2/search/instant?query=${query}`, {
        headers: {
          "x-app-id": "5ee33423",
          "x-app-key": "0d0b0123eadb02b13df0727dfd5633fe",
          ...
          {!showInput ? (
            ...
            <div>
              ...
              onClick={async () => {
                ...
                if (loggedIn) {
                  try {
                    await fetch(`http://localhost:5000/user/${username}/goal`, {
                      method: "POST",
  ...
  async function loginUser(e) {
    ...
    try {
      ...
      setMessage('')
        ...
        try {
          const goalRes = await fetch(`http://localhost:5000/user/${username}/goal`);
                ...
                <div className="calorie-visual">
                  <svg width="120" height="120">
                    ...
                    <circle
                      ...
                      strokeDashoffset={2 * Math.PI * 50 * (1 - caloriesEaten / calorieGoal)}
                      strokeLinecap="round"
                ...
                <div className="meal-select">
                  ...
                  <label>
                    <input
                      ...
                      onChange={() => setSelectedMeal('snacks')}
                    />
                    Snacks
                  </label>
                </div>
